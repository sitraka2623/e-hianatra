      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8 mb-8">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-3xl font-bold text-gray-800 mb-2">{course.titre}</h1>
              <p className="text-gray-600">{course.description}</p>
              <span className="inline-block mt-4 bg-primary-100 text-primary-700 px-4 py-2 rounded-full text-sm font-semibold">
                {course.categorie}
              </span>
            </div>
            <button
        ...
        <div className="bg-white rounded-2xl shadow-soft overflow-hidden">
          <div className="flex border-b">
            ...
            >
              <FiBook className="mr-2" /> Chapitres ({chapters.length})
            </button>
            <button
            ...
            >
              <FiCheckSquare className="mr-2" /> Quiz ({quizzes.length})
            </button>
            <button
            ...
            >
              <FiFileText className="mr-2" /> Devoirs ({assignments.length})
            </button>
          </div>
